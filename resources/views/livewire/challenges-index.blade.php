                ...
                @if ($challenges->hasPages())
                    <nav>
                        <ul class="pagination">
                            ...
                            @else
                                <li class="page-item">
                                    <a class="page-link" href="{{ $challenges->previousPageUrl() }}" rel="prev">&lt;</a>
                                </li>
                            @endif

                            @foreach ($challenges->links()->elements as $element)
                            ...
                            @if ($challenges->hasMorePages())
                                <li class="page-item">
                                    <a class="page-link" href="{{ $challenges->nextPageUrl() }}" rel="next">&gt;</a>
                                </li>
                            @else
                                <li class="page-item disabled" aria-disabled="true">
                                    <span class="page-link">&gt;</span>
