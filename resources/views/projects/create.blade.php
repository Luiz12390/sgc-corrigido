...
@section('title', 'Criar Novo Projeto | SGC-Chapecó')
...
<div class="page-container">
    <div class="page-header"><h1>Criar Novo Projeto</h1></div>
    <div class="card">
        <form action="{{ route('projects.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea id="objectives" name="objectives" required>{{ old('objectives') }}</textarea>
            </div>
            <div class="form-group">
                <label for="cover_image_path">Imagem de Capa</label>
                <input type="file" id="cover_image_path" name="cover_image_path">
            </div>
            <button type="submit" class="btn-submit">Publicar Projeto</button>
        </form>
    </div>
</div>
@endsection
