            ...
            <nav class="main-nav">
                <ul>
                    ...
                    <li class="nav-item-dropdown">
                        <a href="#" class="nav-link-dropdown-toggle {{ request()->routeIs('challenges.*') ? 'active' : '' }}">
                            <span>Desafios</span>
                    ...
                    <li class="nav-item-dropdown">
                        <a href="#" class="nav-link-dropdown-toggle {{ request()->routeIs('projects.*') ? 'active' : '' }}">
                            <span>Projetos</span>
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16"><path fill-rule="evenodd" d="M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z"/></svg>
                        </a>
                        <div class="nav-dropdown-menu">
        ...
        <div class="header-right">
            ...
            <div class="profile-dropdown">
                <div class="profile-trigger">
                    ...
                    @else
                        <img src="https://ui-avatars.com/api/?name=?&color=7F9CF5&background=EBF4FF" alt="Foto de visitante" class="profile-pic">
                    @endauth
                </div>
