...
ARG PHP_VERSION=8.2
# O ARG NODE_VERSION não é mais usado, mas não faz mal deixá-lo
ARG NODE_VERSION=18
...
# Esta etapa agora copiará as suas pastas 'vendor' e 'public/build' locais
COPY . /var/www/html
WORKDIR /var/www/html

# 4. Setup application dependencies
# REMOVEMOS o 'composer install' daqui
...
#
# --- TODA A ETAPA DE "Multi-stage build: Build static assets" FOI REMOVIDA ---
# --- (Porque já fizemos 'npm run build' localmente) ---
#
